...
{
    [TestFixture]
    class TACAlebraicIdentities_Tests :  TACTestsBase
    {
        string messageErrorResult = "Результат неверный";
        string messageErrorArgument1 = "Первый аргумент неверный";
        string messageErrorArgument2 = "Второй аргумент неверный";
        string messageErrorCheckOptimize = "Оптимизация не прошла";
        string messageErrorOperationIsWrong = "Тип оптимизации неверный";
        string messageErrorLabel = "Метка неверна";

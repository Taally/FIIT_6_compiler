...
![Рис. 1. Пример, иллюстрирующий принцип работы алгоритма](3_AvailableExpressionsApplication/pic1.png)
...
![Рис. 2 Результат применения оптимизации к блоку 4](3_AvailableExpressionsApplication/pic2.png)
...
![Рис. 3. Результат разбиения программы с циклом на базовые блоки из листинга 2](3_AvailableExpressionsApplication/pic3.png)
...
![Рис. 4. Результат разбиения на блоки программы с циклом из листинга 3](3_AvailableExpressionsApplication/pic4.png)

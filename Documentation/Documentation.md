...
[3. Создание базового визитора для оптимизаций абстрактного синтаксического дерева](#ChangeVisitor)

[4. AST-оптимизация заменой оператора присваивания вида x = x на пустой узел](#OptAssignEquality)

[5. AST-оптимизация замены оператора сравнения двух значений на его булево значение](#OptExprEqualBoolNum)

[6. AST-оптимизации свертки и устранения унарных операций](#OptExprFoldUnary&TransformUnaryToValue)

[7. AST-оптимизация замены сравнения переменной с собой на true](#OptExprVarEqualToItself)

[8. AST-оптимизация замены сравнения переменной с собой на булевскую константу false](#OptExprSimilarNotEqual)

[9. AST-оптимизация умножения на единицу слева и справа, деления на единицу справа](#OptExprMultDivByOne)

[10. AST-оптимизация заменой условного оператора на пустой оператор](#OptIfNullElseNull)

[11. AST-оптимизация замены if(true) на его true ветку](#OptStatIfTrue)

[12. AST-оптимизация замены if(false) на его else ветку](#OptStatIfFalse)

[13. AST-оптимизация замены while(false) st ветки на null](#OptWhileFalseVisitor)

[14. Генерация трехадресного кода](#GenerationTAC)

[15. Def-Use информация и удаление мертвого кода на ее основе](#DefUse)

[16. Живые и мёртвые переменные и удаление мёртвого кода (замена на пустой оператор)](#DeleteDeadCodeWithDeadVars)

[17. Устранение переходов через переходы](#GotoThroughGoto)

[18. Устранение переходов к переходам](#GotoToGoto)

[19. Удаление пустых операторов в трехадресном коде](#RemoveNoopInTac)

[20. Создание структуры ББл](#BasicBlockStructure)

[21. Разбиение на ББл (от лидера до лидера)](#BasicBlockLeader)

[22. Удаление нидостижимого кода](#CFGUnreachableCodeElimination)
...
[26. Анализ достигающих определений](#ReachingDefinitions)

[27. Итерационный алгоритм в обобщённой структуре](#GenericIterativeAlgorithm)

[28. Классификация рёбер графа: наступающие, отступающие, поперечные (по построенному остовному дереву)](#CFGEdgesСlassification)

[29. Построение дерева доминаторов](#DominatorTree)
...
Выполняется проверка на не удаление L2: noop, который является последней операцией в программе.## Создание структуры ББл
 {#BasicBlockStructure}

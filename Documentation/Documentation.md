...
-   [Создание базового визитора для оптимизаций абстрактного
    ...
    -   [Тесты](#тесты)
-   [AST-оптимизация заменой оператора присваивания вида x = x на пустой
...
-   [AST-оптимизация замены сравнения переменной с собой на
    ...
    -   [Тесты](#тесты-4)
-   [AST-оптимизация замены сравнения переменной с собой на булевскую
    константу
...
-   [AST-оптимизация замены if(true) на его true
    ветку](#ast-оптимизация-замены-iftrue-на-его-true-ветку)
...
-   [AST-оптимизация замены if(false) на его else
    ветку](#ast-оптимизация-замены-iffalse-на-его-else-ветку)
...
-   [Def-Use информация и удаление мертвого кода на ее
    основе](#def-use-информация-и-удаление-мертвого-кода-на-ее-основе)
...
-   [Устранение переходов к
    ...
    -   [Тесты](#тесты-13)
-   [Удаление пустых операторов в трехадресном
    коде](#удаление-пустых-операторов-в-трехадресном-коде)
    ...
    -   [Тесты](#тесты-14)
-   [Создание структуры ББл](#создание-структуры-ббл)
...
-   [Разбиение на ББл (от лидера до
    лидера)](#разбиение-на-ббл-от-лидера-до-лидера)
    ...
    -   [Тесты](#тесты-15)
-   [Удаление нидостижимого кода](#удаление-нидостижимого-кода)
...
-   [Анализ активных переменных](#анализ-активных-переменных)
    ...
    -   [Тесты](#тесты-19)
-   [Анализ достигающих определений](#анализ-достигающих-определений)
...
-   [Итерационный алгоритм в обобщённой
    ...
    -   [Тесты](#тесты-21)
-   [Классификация рёбер графа: наступающие, отступающие, поперечные (по
    построенному остовному

...
namespace ProgramTree
{
    ...
    public class IdNode : ExprNode
    {
        ...
        public override void Visit(Visitor v) => v.VisitIdNode(this);
    }
    ...
    public class BoolValNode : ExprNode
    {
        ...
        public override void Visit(Visitor v) => v.VisitBoolValNode(this);
    }
    ...
    public class BinOpNode : ExprNode
    {
        ...
        public override void Visit(Visitor v) => v.VisitBinOpNode(this);
    }
    ...
    public class WhileNode : StatementNode
    {
        ...
        public override void Visit(Visitor v) => v.VisitWhileNode(this);
    }
    ...
    public class ForNode : StatementNode
    {
        ...
        public override void Visit(Visitor v) => v.VisitForNode(this);
    }

    public class StListNode : StatementNode
    {
        public StListNode(StatementNode stat) => Add(stat);

        public void Add(StatementNode stat) => StatChildren.Add(stat);

        public override void Visit(Visitor v) => v.VisitStListNode(this);
    }
    ...
    public class IfElseNode : StatementNode
    {
        ...
        public override void Visit(Visitor v) => v.VisitIfElseNode(this);
    }
    ...
    public class PrintNode : StatementNode
    {
        ...
        public override void Visit(Visitor v) => v.VisitPrintNode(this);
    }
    ...
    public class InputNode : StatementNode
    {
        ...
        public override void Visit(Visitor v) => v.VisitInputNode(this);
    }
    ...
    public class ExprListNode : ExprNode
    {
        ...
        public override void Visit(Visitor v) => v.VisitExprListNode(this);
    }
    ...
    {
        public override void Visit(Visitor v) => v.VisitEmptyNode(this);
    }
    ...
    public class GotoNode : StatementNode
    {
        ...
        public override void Visit(Visitor v) => v.VisitGotoNode(this);
    }

    public class LabelStatementNode : StatementNode
    {
        public IntNumNode Label { get; set; }
        public StatementNode Stat { get => StatChildren[0]; set => StatChildren[0] = value; }
        public LabelStatementNode(int num, StatementNode stat)
        {
            Label = new IntNumNode(num);
            StatChildren.Add(stat);
        }
        public override void Visit(Visitor v) => v.VisitLabelstatementNode(this);
    }
    ...
    public class BlockNode : StatementNode
    {
        ...
        public override void Visit(Visitor v) => v.VisitBlockNode(this);
    }
}

...
ident 	: ID { $$ = new IdNode((string)$1); }
		;

assign 	: ident ASSIGN expr { $$ = new AssignNode($1 as IdNode, $3 as ExprNode); }
		;
...
goto	: GOTO INUM { $$ = new GotoNode(new IntNumNode($2)); }
		;

labelstatement	: INUM COLON statement { $$ = new LabelStatementNode(new IntNumNode($1), $3); }
		;
%%